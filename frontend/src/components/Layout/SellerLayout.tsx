...
import {  User, LogOut, Menu, X,  Home, Package } from 'lucide-react';
import { useAuth } from '../../contexts/AuthContext';
// import { useAuth } from '../contexts/AuthContext'; // Assuming useAuth provides a logout function

const navigationItems = [
  { id: 'dashboard', label: 'Dashboard', icon: Home, to: '/seller' },
  { id: 'orders', label: 'Orders', icon:Package , to  : '/seller/orders' },
  { id: 'profile', label: 'Profile', icon: User, to: '/seller/profile' },
];
