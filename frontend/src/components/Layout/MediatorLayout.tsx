...
const navigationItems = [
  { id: 'dashboard', label: 'Dashboard', icon: Home, to: '/mediator' },
  { id: 'orders', label: 'My Orders', icon: Package, to: '/mediator/orders' },
  { id: 'refunds', label: 'My Refunds', icon: RefreshCw, to: '/mediator/refunds' },
  { id: 'activedeals', label: 'Active Deals', icon: ShoppingCart, to: '/mediator/activedeals' },
  { id: 'profile', label: 'Profile', icon: User, to: '/mediator/profile' },
];

const MediatorLayout: React.FC = () => {
