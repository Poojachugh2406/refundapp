...
const MediatorActiveDeals: React.FC<ActiveDealsProps> = () => {
  const navigate = useNavigate();
  // const [products, setProducts] = useState<ActiveProduct[]>([]);
  // const [loading, setLoading] = useState(true);
  // const [error, setError] = useState('');
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 sm:p-6 max-w-2xl mx-auto">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-red-800 font-semibold text-base sm:text-lg mb-2">Unable to load deals Something Went wrong</h3>
...
export default MediatorActiveDeals;