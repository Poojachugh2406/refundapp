...
import { User, Lock, Mail, Phone, Save, Eye, EyeOff, CheckCircle, RefreshCw } from 'lucide-react';
...
const SellerProfile: React.FC = () => {
  ...
  const fetchUserProfile = async () => {
    try {
      ...
      const response:any = await apiGet<UserProfile>('/auth/me');
  ...
  const onProfileSubmit = async (data: ProfileFormData) => {
    ...
    try {
      ...
      const response:any = await userAPI.updateProfile({name:data.name ,phone :data.phone})
      if (response.success) {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="md:col-span-2">
                    <Input
                      ...
                      helperText="This will be used for order and refund verification"
                    />
                  </div>
                </div>
