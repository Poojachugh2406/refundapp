...
const SellerLogin: React.FC = () => {
  ...
  const onSubmit = async (data: LoginCredentials) => {
    ...
    try {
      await login({...data, role:'seller'});
      toast.success('Login successful!');
      console.log("teimakaasdfasdfh")
      navigate('/refund');
    } catch (error: any) {
  ...
  return (
    <div className="min-h-screen w-full grid grid-cols-1 lg:grid-cols-2 bg-white">
      ...
      {/* --- Branding Panel (Left Side) - Seller Theme --- */}
      <div className="relative hidden lg:flex flex-col justify-between p-12 bg-gradient-to-br from-emerald-500 to-teal-600 text-white">
        ...
        <div className="z-10 max-w-lg">
          ...
          <p className="text-lg text-teal-100 font-light">
            Access your seller dashboard to manage Orders and Refunds .
          </p>
        </div>
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div>
            ...
            <p className="mt-2 text-gray-600">
             Seller access only.{' '}
              <Link to="/seller/register" className="font-semibold text-emerald-600 hover:text-emerald-700">
